  ...
  return (
    <div className="bg-[#fff7f3]">
      ...
      <div className=" text-[#332e2e] text-xl  pt-10 mb-30 ">
        <h1 className="text-6xl font-bold pl-50 max-sm:px-5 sm:max-xl:pl-5 max-xl:mb-10 "> I'm Kirtesh Shirodkar</h1>
        <div className="flex flex-row items-center pl-50 max-sm:px-5 sm:max-xl:pl-5 max-sm:flex-col-reverse ">
          <div className="pr-25 sm:max-xl:pr-5 max-sm:pr-5">
            ...
            <p className="mb-10">
              ...
              pursuing my Bachelor of Computer Applications (BCA) at Don Bosco
              College, Panjim, I have a strong foundation in programming and a
              keen interest in creating seamless, user-friendly web experiences.
            </p>
          ...
          <div className="pr-25 sm:max-xl:pr-5 max-sm:p-0  ml-20 sm:max-xl:ml-5 max-sm:m-0">
            <h1 className="text-3xl font-medium mb-5">What I Do</h1>
              ...
              <ol className="space-y-5 mb-10">
                <li>
                  <b>Freelance Web Development</b> – I design and maintain
                  client websites, focusing on performance, accessibility, and
                  aesthetics.
                </li>
                <li>
                ...
                <li>
                  <b>Project Building</b> – Some of my notable projects include
                  a Nike-themed static website and a Weather App, showcasing my
